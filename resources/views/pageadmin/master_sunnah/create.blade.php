                    ...
                    <div class="card border-top border-0 border-4 border-primary">
                        <div class="card-body p-5">
                            <div class="card-title d-flex align-items-center">
                                ...
                                <h5 class="mb-0 text-primary">Tambah Data Sunnah</h5>
                            </div>
                            <hr>
                            <form action="{{ route('master-sunnah.store') }}" method="POST" class="row g-3" enctype="multipart/form-data">
                                @csrf
                                <div class="col-md-12">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <textarea class="form-control" id="dalil" name="dalil" placeholder="Dalil" required></textarea>
                                </div>
                                <div class="col-md-12">
